...
class Tree():
    ...
    def delete_node(self, data):
        ...
        #save children ?
        left_child = found_node._left_child
        right_child = found_node._right_child

        #remove this?
        if found_node is self._root_node:
            pass
        ...
        #if only 1 child
        if (found_node._left_child is not None and found_node._right_child is None) or (found_node._left_child is None and found_node._right_child is not None):

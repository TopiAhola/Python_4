...
class IntArray():
    ...
    def remove(self, index: int) -> int:
        ...
        #
        removed_element = self.__getitem__(index)

        #move trailing elements by 1
        for pointer in range(index, self._size - 1, 1):
            self.__setitem__( pointer, self.__getitem__(pointer + 1) )

...
class DoublyLinkedList:
    ...
    def insert(self, index, value):
        ...
        previous_node = None
        current_node = self._head
        next_node = self._head.next if self._head else None
        searchIndex = 0
        ...
        #insert new node
        newNode = ListNode(value, next=current_node, prev=previous_node)

        #set pointer between current and new nodes
        if current_node is not None:
            current_node.prev = newNode

        #set pointer between prev and new nodes
        ...
        #inserting to tail doesn't change tail if tail is not None

...
def DFS(graph, u, visited=None):
    ...
    #search function
    def recursive_deep_search(target_vertex, origin_vertex, graph, dictionary, visited):
        ...
        if len(edges) > 0:
            for child_vertex in edges.keys():
                if child_vertex not in visited:
                    recursive_deep_search(child_vertex, target_vertex, graph, dictionary, visited)
    ...
    dictionary = {}
    origin = None
    recursive_deep_search(u, origin, graph, dictionary, visited)
